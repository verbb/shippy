...
class AramexNewZealand extends AbstractCarrier
{
    // Static Methods
    // =========================================================================
    ...
    public function setClientId(?string $clientId): AramexNewZealand
    {
    ...
    public function setClientSecret(?string $clientSecret): AramexNewZealand
    {
    ...
    public function getHttpClient(): HttpClient
    {
        return new HttpClient([
            'base_uri' => 'https://api.aramexconnect.co.nz',
            'headers' => [
    ...
    {
        $cacheKey = md5('aramex-nz|' . $this->clientId);
        ...
        $authResponse = Json::decode((string)(new HttpClient())
            ->request('POST', 'https://identity.aramexconnect.co.nz/connect/token', [
                'form_params' => [
